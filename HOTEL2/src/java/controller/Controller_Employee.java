...
import br.com.commandfactory.employee.ICommand;
...
public class Controller_Employee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         String paramAction = request.getParameter("btnoperacaoemployee");
            String nomeDaClasse = "br.com.commandfactory.employee." + paramAction + "EmployeeAction";
