...
import br.com.commandfactory.account.ICommand;
...
public class Controller_Account extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String paraAction = request.getParameter("btnoperacaoaccount");
            String nomeDaClasse = "br.com.commandfactory.account." + paraAction + "AccountAction";
