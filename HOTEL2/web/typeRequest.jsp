...
<html>
    ...
    <body>
        ...
        <script>
            function confirmarDelecao(idTypeRequest) {
                const confirmacao = confirm("Deseja deletar ?");
                if (confirmacao) {
                    // Redireciona para o Controller com o ID da conta
                    window.location.href = 'Controller_TypeRequest?btnoperacaotyperequest=Delete&txtidtyperequest=' + idTypeRequest;
                } else {
        ...
        <main class="container">
            <div class="login_form">
                ...
                <div class="table-container">
                    <% List<TypeRequest> lista = (List<TypeRequest>) request.getAttribute("lista");
                    ...
                    <table class="fl-table">
                        ...
                        <tbody>
                            <% for (TypeRequest typerequest : lista) {%>
                            <tr>
                                <td><%= typerequest.getTypeRequest()%></td>
                                <td><a href="#" onclick="confirmarDelecao(<%= typerequest.getIdTypeRequest()%>)">
                                        <img src="imagem/trash.png" alt="Deletar"></a>
                                </td>
                                <td><a href="Controller_TypeRequest?btnoperacaotyperequest=Update&txtidtyperequest=<%= typerequest.getIdTypeRequest()%>">
                ...
                <div class="botoes">
                    <button onclick="window.location.href = 'typeRequestRegister.jsp'" class="botao botao-primario">Cadastrar Tipo Solicitação</button>
